...
const Login = () => {
  ...
  //เป็นส่วนที่เวลาเรา Login เข้าแล้ว Username แล้วจะไม่สามารถเข้าหน้า Login ในขณะที่ Logged in แล้วได้
  ...
  return (
    <div className="container mx-auto max-w-96 my auto">
      ...
      <label className="input input-bordered flex items-center gap-2">
        ...
        <input type="password" className="grow" placeholder="Password" onChange={handleChange} name="userPassword" value={user.userPassword}/>
      </label>
